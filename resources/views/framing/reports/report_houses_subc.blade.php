...
<section class="rep_hpuses" style="padding: 20px;">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6"><a href="/rep_houses_subc_PDF/{{$status}}/{{$subcontractor->id}}" class="btn btn-default pull-right"><i class="fa fa-download"></i></a></div>
		</div>
		<div class="row">
			<div class="col-md-11">
				...
				<h4 align="left">Subcontractor: {{$subcontractor->name}}</h4>
			</div>
