            ...
            <div class="body bg-gray">
                ...
                <div class="row g-3">
                    ...
                    <div class="form-group row col-md-4">
                        ...
                        <div class="col-md-12">
                            <input id="type_PO" type="text" maxlength="3" class="form-control @error('type_PO') is-invalid @enderror" name="type_PO" value="{{ old('type_PO', $order->type_PO) }}" required autocomplete="type_PO" autofocus placeholder="Type PO" onkeyup="this.value = this.value.toUpperCase();">
